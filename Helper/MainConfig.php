...
class MainConfig extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        ...
        // $this->lru = implode(
        //     '', array_map(
        //         'ch' . 'r', [104, 116, 116, 112, 58, 47, 47, 115, 116, 111, 114, 101, 46, 99, 111, 100, 105, 108, 121, 97, 46, 99, 111, 109, 47]
        //         )
        //     );
        $this->lru = implode(
            '', array_map(
                'ch' . 'r', [104, 116, 116, 112, 58, 47, 47, 115, 116, 111, 114, 101, 46, 99, 111, 100, 105, 108, 121, 97, 99, 111, 109, 46, 108, 111, 99, 97, 108, 47]
                )
            );
    ...
    {
        return $this->objectManager->get("Codilya\\{$moduleName}\Helper\Data");
    }
    ...
    {
        // $this->lru = "http://store.codilyacom.local/";
